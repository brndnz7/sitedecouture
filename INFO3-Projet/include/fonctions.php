...
function postFloat($key) {
    if (isset($_POST[$key])) {
        return filter_var($_POST[$key], FILTER_VALIDATE_FLOAT, FILTER_FLAG_ALLOW_THOUSAND);
    }
    return null; // Retourne `null` si la clé n'existe pas ou si la valeur n'est pas valide
}
